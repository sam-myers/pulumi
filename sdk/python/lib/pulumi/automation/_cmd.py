...
class PulumiCommandOptions:
    root: Optional[str] = None
    version: Optional[VersionInfo] = None
    skipVersionCheck: Optional[bool] = False
...
class PulumiCommand:
    ...
    def __init__(
        ...
        :param skip_version_check: If true the version validation will be skipped.
        """
    ...
    def install(
        ...
        """
        Installs the Pulumi CLI. If root is not specified, the CLI is
        installed to ~/.pulumi/versions/<version>. If version is not
        specified, the version matching the SDK version is installed.

        :param root: The root directory to install the CLI to.
